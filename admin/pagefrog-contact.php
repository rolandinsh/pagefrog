        ...
        <div class="col-sm-6 margin-top-bottom">
          ...
          <form action="" id="pagefrog-contact-form">
            <div class="form-group margin-top-bottom">
              ...
              <input id="pagefrog-contact-form-name" name="name" type="text" class="form-control" value="<?php global $current_user;
wp_get_current_user();
if ($current_user->display_name) {
    echo $current_user->display_name;
            ...
            <div class="form-group margin-top-bottom">
              ...
              <input id="pagefrog-contact-form-email" name="email" type="text" class="form-control" value="<?php global $current_user;
if ($current_user->user_email) {
    echo $current_user->user_email;
} ?>" placeholder="clark@superman.com">
            </div>
            <div class="form-group margin-top-bottom">
          ...
          <a href="https://twitter.com/PageFrog" class="twitter-follow-button">Follow @PageFrog</a>

          &nbsp;&nbsp;&nbsp;&nbsp;
          <a class="fb-like" href="https://www.facebook.com/pagefrog">facebook.com/pagefrog</a>
        </div>
      </div>
