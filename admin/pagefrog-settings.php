...
function add_new_post_settings_fields()
{
    ...
    register_setting(
            PageFrog_NewPostSettings_Storage::OPTIONS_KEY, PageFrog_NewPostSettings_Storage::OPTIONS_KEY, 'PageFrog_NewPostSettings_Storage::validate'
    );
    add_settings_section(
            PageFrog_NewPostSettings_Storage::OPTIONS_KEY, '', 'render_new_post_main_description', $GLOBALS['PAGEFROG_SETTINGS_PAGE_SLUG']
    );

    add_settings_field(
            'amp_disable_other_plugins', '', 'render_amp_disable_other_plugins', $GLOBALS['PAGEFROG_SETTINGS_PAGE_SLUG'], PageFrog_NewPostSettings_Storage::OPTIONS_KEY, array('new_post' => $new_post)
    );

    add_settings_field(
            'fbia_disable_other_plugins', '', 'render_fbia_disable_other_plugins', $GLOBALS['PAGEFROG_SETTINGS_PAGE_SLUG'], PageFrog_NewPostSettings_Storage::OPTIONS_KEY, array('new_post' => $new_post)
    );

    add_settings_field(
            'amp_show_header_images', '', 'render_amp_show_header_images', $GLOBALS['PAGEFROG_SETTINGS_PAGE_SLUG'], PageFrog_NewPostSettings_Storage::OPTIONS_KEY, array('new_post' => $new_post)
    );

    add_settings_field(
            'fbia_show_header_images', '', 'render_fbia_show_header_images', $GLOBALS['PAGEFROG_SETTINGS_PAGE_SLUG'], PageFrog_NewPostSettings_Storage::OPTIONS_KEY, array('new_post' => $new_post)
    );

    foreach ($post_types as $label => $post_type) {
        add_settings_field(
                'amp_enable_new_' . $label, '', 'render_amp_enable_new_generic_post', $GLOBALS['PAGEFROG_SETTINGS_PAGE_SLUG'], PageFrog_NewPostSettings_Storage::OPTIONS_KEY, array(
            'new_post' => $new_post,
            'post_type' => $post_type,
            'label' => $label
                )
        ...
        add_settings_field(
                'fbia_enable_new_' . $label, '', 'render_fbia_enable_new_generic_post', $GLOBALS['PAGEFROG_SETTINGS_PAGE_SLUG'], PageFrog_NewPostSettings_Storage::OPTIONS_KEY, array(
            'new_post' => $new_post,
            'post_type' => $post_type,
            'label' => $label
                )
