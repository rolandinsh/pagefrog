...
function add_analytics_settings_fields()
{
    ...
    register_setting(
            PageFrog_Analytics_Storage::OPTIONS_KEY, PageFrog_Analytics_Storage::OPTIONS_KEY, 'PageFrog_Analytics_Storage::validate'
    );

    add_settings_section(
            PageFrog_Analytics_Storage::OPTIONS_KEY, '', 'render_analytics_main_description', $GLOBALS['PAGEFROG_ANALYTICS_PAGE_SLUG']
    );

    add_settings_field(
            'chartbeat_api_key', '', 'render_chartbeat_api_key', $GLOBALS['PAGEFROG_ANALYTICS_PAGE_SLUG'], PageFrog_Analytics_Storage::OPTIONS_KEY, array('analytics' => $analytics)
    );

    add_settings_field(
            'chartbeat_uid', '', 'render_chartbeat_uid', $GLOBALS['PAGEFROG_ANALYTICS_PAGE_SLUG'], PageFrog_Analytics_Storage::OPTIONS_KEY, array('analytics' => $analytics)
    );

    add_settings_field(
            'chartbeat_enabled', '', 'render_chartbeat_enabled', $GLOBALS['PAGEFROG_ANALYTICS_PAGE_SLUG'], PageFrog_Analytics_Storage::OPTIONS_KEY, array('analytics' => $analytics)
    );

    add_settings_field(
            'parsely_api_key', '', 'render_parsely_api_key', $GLOBALS['PAGEFROG_ANALYTICS_PAGE_SLUG'], PageFrog_Analytics_Storage::OPTIONS_KEY, array('analytics' => $analytics)
    );

    add_settings_field(
            'parsely_api_secret', '', 'render_parsely_api_secret', $GLOBALS['PAGEFROG_ANALYTICS_PAGE_SLUG'], PageFrog_Analytics_Storage::OPTIONS_KEY, array('analytics' => $analytics)
    );

    add_settings_field(
            'parsely_enabled', '', 'render_parsely_enabled', $GLOBALS['PAGEFROG_ANALYTICS_PAGE_SLUG'], PageFrog_Analytics_Storage::OPTIONS_KEY, array('analytics' => $analytics)
    );

    add_settings_field(
            'other_amp_analytics_code', '', 'render_other_amp_analytics_code', $GLOBALS['PAGEFROG_ANALYTICS_PAGE_SLUG'], PageFrog_Analytics_Storage::OPTIONS_KEY, array('analytics' => $analytics)
    );

    add_settings_field(
            'other_fbia_analytics_code', '', 'render_other_fbia_analytics_code', $GLOBALS['PAGEFROG_ANALYTICS_PAGE_SLUG'], PageFrog_Analytics_Storage::OPTIONS_KEY, array('analytics' => $analytics)
    );

    add_settings_field(
            'other_analytics_enabled', '', 'render_other_analytics_enabled', $GLOBALS['PAGEFROG_ANALYTICS_PAGE_SLUG'], PageFrog_Analytics_Storage::OPTIONS_KEY, array('analytics' => $analytics)
    );

    add_settings_field(
            'google_analytics_enabled', '', 'render_google_analytics_enabled', $GLOBALS['PAGEFROG_ANALYTICS_PAGE_SLUG'], PageFrog_Analytics_Storage::OPTIONS_KEY, array('analytics' => $analytics)
    );

    add_settings_field(
            'google_analytics_access_token', '', 'render_google_analytics_access_token', $GLOBALS['PAGEFROG_ANALYTICS_PAGE_SLUG'], PageFrog_Analytics_Storage::OPTIONS_KEY, array('analytics' => $analytics)
    );

    add_settings_field(
            'google_analytics_refresh_token', '', 'render_google_analytics_refresh_token', $GLOBALS['PAGEFROG_ANALYTICS_PAGE_SLUG'], PageFrog_Analytics_Storage::OPTIONS_KEY, array('analytics' => $analytics)
    );

    add_settings_field(
            'google_analytics_site_id', '', 'render_google_analytics_site_id', $GLOBALS['PAGEFROG_ANALYTICS_PAGE_SLUG'], PageFrog_Analytics_Storage::OPTIONS_KEY, array('analytics' => $analytics)
    );
}
