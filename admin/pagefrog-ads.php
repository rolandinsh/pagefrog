...
function add_ads_settings_fields()
{
    ...
    register_setting(
            PageFrog_AdSettings_Storage::OPTIONS_KEY, PageFrog_AdSettings_Storage::OPTIONS_KEY, 'PageFrog_AdSettings_Storage::validate'
    );

    add_settings_section(
            PageFrog_AdSettings_Storage::OPTIONS_KEY, '', 'render_ads_main_description', $GLOBALS['PAGEFROG_ADS_PAGE_SLUG']
    );

    add_settings_field(
            'fbia_enable_auto_ads', '', 'render_fbia_enable_auto_ads', $GLOBALS['PAGEFROG_ADS_PAGE_SLUG'], PageFrog_AdSettings_Storage::OPTIONS_KEY, array('ads' => $ads)
    );

    add_settings_field(
            'fbia_placement_id', '', 'render_fbia_placement_id', $GLOBALS['PAGEFROG_ADS_PAGE_SLUG'], PageFrog_AdSettings_Storage::OPTIONS_KEY, array('ads' => $ads)
    );

    add_settings_field(
            'google_adsense_access_token', '', 'render_google_adsense_access_token', $GLOBALS['PAGEFROG_ADS_PAGE_SLUG'], PageFrog_AdSettings_Storage::OPTIONS_KEY, array('ads' => $ads)
    );

    add_settings_field(
            'google_adsense_refresh_token', '', 'render_google_adsense_refresh_token', $GLOBALS['PAGEFROG_ADS_PAGE_SLUG'], PageFrog_AdSettings_Storage::OPTIONS_KEY, array('ads' => $ads)
    );

    add_settings_field(
            'google_adsense_account_id', '', 'render_google_adsense_account_id', $GLOBALS['PAGEFROG_ADS_PAGE_SLUG'], PageFrog_AdSettings_Storage::OPTIONS_KEY, array('ads' => $ads)
    );

    add_settings_field(
            'google_adsense_account_name', '', 'render_google_adsense_account_name', $GLOBALS['PAGEFROG_ADS_PAGE_SLUG'], PageFrog_AdSettings_Storage::OPTIONS_KEY, array('ads' => $ads)
    );

    add_settings_field(
            'google_adsense_adunit_name', '', 'render_google_adsense_adunit_name', $GLOBALS['PAGEFROG_ADS_PAGE_SLUG'], PageFrog_AdSettings_Storage::OPTIONS_KEY, array('ads' => $ads)
    );

    add_settings_field(
            'google_adsense_adunit_dimensions', '', 'render_google_adsense_adunit_dimensions', $GLOBALS['PAGEFROG_ADS_PAGE_SLUG'], PageFrog_AdSettings_Storage::OPTIONS_KEY, array('ads' => $ads)
    );

    add_settings_field(
            'google_adsense_adunit_id', '', 'render_google_adsense_adunit_id', $GLOBALS['PAGEFROG_ADS_PAGE_SLUG'], PageFrog_AdSettings_Storage::OPTIONS_KEY, array('ads' => $ads)
    );

    add_settings_field(
            'amp_enable_google_adsense', '', 'render_amp_enable_google_adsense', $GLOBALS['PAGEFROG_ADS_PAGE_SLUG'], PageFrog_AdSettings_Storage::OPTIONS_KEY, array('ads' => $ads)
    );

    add_settings_field(
            'amp_words_per_ad', '', 'render_amp_words_per_ad', $GLOBALS['PAGEFROG_ADS_PAGE_SLUG'], PageFrog_AdSettings_Storage::OPTIONS_KEY, array('ads' => $ads)
    );
}
            ...
            <div class="col-sm-12">
              ...
              <div class="row">
                <div class="col-sm-12">
                  <div class="row">
                          <?php
                          if ($google_adsense->is_authorized()) {
