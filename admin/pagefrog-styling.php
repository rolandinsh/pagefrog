...
function add_styling_settings_fields()
{
    ...
    add_settings_field(
            'pagefrog_id_bar_type', '', 'render_id_bar_type', $GLOBALS['PAGEFROG_STYLING_PAGE_SLUG'], 'pagefrog_main', array('styling' => $styling)
    );

    add_settings_field(
            'pagefrog_id_bar_color', '', 'render_id_bar_color', $GLOBALS['PAGEFROG_STYLING_PAGE_SLUG'], 'pagefrog_main', array('styling' => $styling)
    );

    add_settings_field(
            'pagefrog_title_font_family', '', 'render_title_font_family', $GLOBALS['PAGEFROG_STYLING_PAGE_SLUG'], 'pagefrog_main', array('styling' => $styling)
    );

    add_settings_field(
            'pagefrog_title_font_color', '', 'render_title_font_color', $GLOBALS['PAGEFROG_STYLING_PAGE_SLUG'], 'pagefrog_main', array('styling' => $styling)
    );

    add_settings_field(
            'pagefrog_headings_font_family', '', 'render_headings_font_family', $GLOBALS['PAGEFROG_STYLING_PAGE_SLUG'], 'pagefrog_main', array('styling' => $styling)
    );

    add_settings_field(
            'pagefrog_headings_font_color', '', 'render_headings_font_color', $GLOBALS['PAGEFROG_STYLING_PAGE_SLUG'], 'pagefrog_main', array('styling' => $styling)
    );

    add_settings_field(
            'pagefrog_body_text_font_family', '', 'render_body_text_font_family', $GLOBALS['PAGEFROG_STYLING_PAGE_SLUG'], 'pagefrog_main', array('styling' => $styling)
    );

    add_settings_field(
            'pagefrog_body_text_font_color', '', 'render_body_text_font_color', $GLOBALS['PAGEFROG_STYLING_PAGE_SLUG'], 'pagefrog_main', array('styling' => $styling)
    );

    add_settings_field(
            'pagefrog_link_decoration', '', 'render_link_decoration', $GLOBALS['PAGEFROG_STYLING_PAGE_SLUG'], 'pagefrog_main', array('styling' => $styling)
    );

    add_settings_field(
            'pagefrog_link_color', '', 'render_link_color', $GLOBALS['PAGEFROG_STYLING_PAGE_SLUG'], 'pagefrog_main', array('styling' => $styling)
    );

    add_settings_field(
            'pagefrog_quotes_font_family', '', 'render_quotes_font_family', $GLOBALS['PAGEFROG_STYLING_PAGE_SLUG'], 'pagefrog_main', array('styling' => $styling)
    );

    add_settings_field(
            'pagefrog_quotes_font_color', '', 'render_quotes_font_color', $GLOBALS['PAGEFROG_STYLING_PAGE_SLUG'], 'pagefrog_main', array('styling' => $styling)
    );

    add_settings_field(
            'pagefrog_footer_text_font_family', '', 'render_footer_text_font_family', $GLOBALS['PAGEFROG_STYLING_PAGE_SLUG'], 'pagefrog_main', array('styling' => $styling)
    );

    add_settings_field(
            'pagefrog_footer_text_font_color', '', 'render_footer_text_font_color', $GLOBALS['PAGEFROG_STYLING_PAGE_SLUG'], 'pagefrog_main', array('styling' => $styling)
    );
}
...
function render_title_font_family($args)
{
    ...
    <div class="row">
      ...
      <div class="col-sm-6 margin-top-bottom">
    <?php
    render_font_selector($args['styling']->get_title_font_family(), 'title_font_family', 'pagefrog-title-font-family');
}
...
function render_headings_font_family($args)
{
    ...
    <div class="row">
      ...
      <div class="col-sm-6 margin-top-bottom">
    <?php
    render_font_selector($args['styling']->get_headings_font_family(), 'headings_font_family', 'pagefrog-headings-font-family');
}
...
function render_body_text_font_family($args)
{
    ...
    <div class="row">
      ...
      <div class="col-sm-6 margin-top-bottom">
    <?php
    render_font_selector($args['styling']->get_body_text_font_family(), 'body_text_font_family', 'pagefrog-body-text-font-family');
}
...
function render_quotes_font_family($args)
{
    ...
    <div class="row">
      ...
      <div class="col-sm-6 margin-top-bottom">
          <?php
          render_font_selector($args['styling']->get_quotes_font_family(), 'quotes_font_family', 'pagefrog-quotes-font-family');
      }
...
function render_footer_text_font_family($args)
{
    ...
    <div class="row">
      ...
      <div class="col-sm-6 margin-top-bottom">
        <?php
        render_font_selector($args['styling']->get_footer_text_font_family(), 'footer_text_font_family', 'pagefrog-footer-text-font-family');
    }
